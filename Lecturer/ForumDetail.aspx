<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForumDetail.aspx.cs" Inherits="LearnSphere_WAPP.Lecturer.ForumDetail" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            <div class="back-container">
                <a href='ViewForum.aspx?courseid=<%= Request.QueryString["courseid"] %>' 
                   class="btn-back">
                    ← Back to Forum
                </a>
            </div>
