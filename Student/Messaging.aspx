<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messaging.aspx.cs" Inherits="LearnSphere_WAPP.Student.Messaging" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="page-header">
                ...
                <div class="page-header-sub">Chat with lecturers from your enrolled courses.</div>
            </div>
            ...
            <div class="chat-layout">
                ...
                <!-- left panel: lecturers from enrolled courses -->
                <div class="lecturers-panel">
                    <div class="panel-header">Your Lecturers</div>
                    <div class="lecturer-list">
                        <asp:Repeater ID="rptLecturers" runat="server" OnItemCommand="rptLecturers_ItemCommand">
                            <ItemTemplate>
                                <div class="lecturer-item <%# Convert.ToInt32(Eval("userid")) == SelectedLecturerId ? "selected" : "" %>"
                                     onclick="selectLecturer(<%# Eval("userid") %>)">
                                    <div class="lecturer-avatar"><%# Eval("fname").ToString().Substring(0,1).ToUpper() %></div>
                        ...
                        <asp:Panel ID="pnlNoLecturers" runat="server" Visible="false">
                            <div class="empty-state">Enroll in courses to message lecturers.</div>
                        </asp:Panel>
                    </div>
                </div>
                ...
                <div class="chat-panel">
                    ...
                    <asp:Panel ID="pnlChat" runat="server" Visible="false" style="display:flex; flex-direction:column; height:100%;">
                        ...
                        <div class="chat-header">
                            <div class="chat-header-avatar"><asp:Label ID="lblChatInitial" runat="server" /></div>
                            <div>
    ...
    <script>
        ...
        function selectLecturer(lecturerId) {
            window.location.href = 'Messaging.aspx?lecturerId=' + lecturerId;
        }
    </script>
</body>
</html>