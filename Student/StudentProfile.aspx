<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="LearnSphere_WAPP.Student.StudentProfile" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="nav">
            ...
            <a href="StudentProfile.aspx" class="active"><span>👤</span> Profile</a>
        ...
        <div class="container">
            ...
            <div class="profile-hero">
                <div class="profile-pic-wrapper">
                    ...
                    <asp:Panel ID="pnlProfileInitial" runat="server" Visible="true">
                        <div class="profile-pic-initial">
                            <asp:Label ID="lblHeroInitial" runat="server" Text="A" />
                        </div>
                    </asp:Panel>
                </div>
            ...
            <div class="card">
                ...
                <asp:Panel ID="pnlView" runat="server">
                    <div class="info-row">
                        ...
                        <span class="info-value"><asp:Label ID="lblFname" runat="server" /></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Last Name</span>
                        <span class="info-value"><asp:Label ID="lblLname" runat="server" /></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Email</span>
                        <span class="info-value"><asp:Label ID="lblEmailView" runat="server" /></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Age</span>
                        <span class="info-value"><asp:Label ID="lblAge" runat="server" /></span>
                    </div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value"><asp:Label ID="lblJoined" runat="server" /></span>
                    </div>
                    <div class="btn-row">
                ...
                <asp:Panel ID="pnlEdit" runat="server" Visible="false">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtAge" runat="server" CssClass="form-input" TextMode="Number" />
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                <div class="card-title"><span class="title-dot"></span> Profile Picture</div>
                <div class="upload-section">
                    <div class="upload-preview">
                        ...
                        <asp:Panel ID="pnlUploadInitial" runat="server" Visible="true">
                            <span class="upload-initial"><asp:Label ID="lblUploadInitial" runat="server" Text="A" /></span>
                        </asp:Panel>
                    </div>
                    <div>
                        <asp:FileUpload ID="fuProfilePic" runat="server" />
                        <br />
                        <asp:Button ID="btnUpload" runat="server" Text="Upload Photo" CssClass="btn-primary" OnClick="btnUpload_Click" style="margin-top:10px;" />
                    </div>
                </div>
            </div>
            ...
            <!-- change password -->
            <div class="card">
                <div class="card-title"><span class="title-dot"></span> Change Password</div>
                <div class="form-grid">
                    <div class="form-group">
