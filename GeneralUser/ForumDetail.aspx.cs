...
namespace LearnSphere_WAPP.GeneralUser
{
    public partial class ForumDetail : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (int.TryParse(Request.QueryString["delete"], out int deletePostId))
                {
        ...
        private void DeletePost(int postIdToDelete)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                cmd.Parameters.AddWithValue("@postid", postIdToDelete);
            ...
            Response.Redirect("ForumDetail.aspx?postid=" + Request.QueryString["postid"] + "&courseid=" + Request.QueryString["courseid"]);
        }
        ...
        {
            if (tagObj == null || string.IsNullOrWhiteSpace(tagObj.ToString())) return "";
        ...
        protected string ShowDeleteButton(object postUserIdObj, object postIdObj)
        {
            ...
            int currentPostId = Convert.ToInt32(postIdObj);

            if (currentUserId == postUserId)
            {
                return $"<a href='ForumDetail.aspx?delete={currentPostId}&postid={Request.QueryString["postid"]}' class='btn-delete'>Delete</a>";
            }
            return "";
        }
    }
