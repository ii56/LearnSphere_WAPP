    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-input {
            ...
            border-radius: var(--radius-sm); padding: 11px 14px; box-sizing: border-box;
        ...
        .btn-pay {
            ...
            padding: 13px; border-radius: var(--radius-sm); margin-top: 8px;
    ...
    <form id="form1" runat="server">
        ...
        <div class="modal-overlay" id="paymentModal">
            <div class="modal">
                ...
                <asp:Button ID="btnConfirmPayment" runat="server" Text="Pay Now & Upgrade" CssClass="btn-pay"
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (hf && hf.value !== '') {
                ...
                if (parts.length >= 3) {
                    openModalWithData(parts[1], parts[2]);
                }
            }
        });
