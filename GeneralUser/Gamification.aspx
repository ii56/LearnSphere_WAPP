<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gamification.aspx.cs" Inherits="LearnSphere_WAPP.GeneralUser.Gamification" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .leaderboard-row.top-1 .rank { color: #f59e0b; font-size: 1.2rem;}
        .leaderboard-row.top-2 .rank { color: #94a3b8; font-size: 1.1rem;}
        .leaderboard-row.top-3 .rank { color: #cd7f32; font-size: 1rem;}
        
        .student-info { display: flex; align-items: center; gap: 12px; }
        .leaderboard-avatar { width: 32px; height: 32px; border-radius: 50%; object-fit: cover; background: var(--border-light); }
        .student-name { font-size: 0.85rem; font-weight: 600; color: var(--text); }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="nav">
            ...
            <a href="Message.aspx"><span>✉️</span> Messages</a>
                    ...
                    <ItemTemplate>
                        <div class='leaderboard-row <%# Convert.ToInt32(Eval("Rank")) == 1 ? "top-1" : Convert.ToInt32(Eval("Rank")) == 2 ? "top-2" : Convert.ToInt32(Eval("Rank")) == 3 ? "top-3" : "" %> <%# Eval("userid").ToString() == Session["userid"].ToString() ? "is-me" : "" %>'>
                            ...
                            <div class="student-info">
                                <img src='<%# Eval("ProfileImage") != DBNull.Value && !string.IsNullOrEmpty(Eval("ProfileImage").ToString()) ? ResolveUrl(Eval("ProfileImage").ToString()) : ResolveUrl("~/images/default-user.png") %>' class="leaderboard-avatar" />
