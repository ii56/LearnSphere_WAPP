<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message.aspx.cs" Inherits="LearnSphere_WAPP.GeneralUser.Message" %>
            ...
            <div class="chat-container">
                    ...
                    <asp:Repeater ID="rptConversations" runat="server" OnItemCommand="rptConversations_ItemCommand">
                        <ItemTemplate>
                            <div class="conversation-item">
                                ...
                                <asp:LinkButton ID="btnOpenChat" runat="server" CommandName="OpenChat" CommandArgument='<%# Eval("conversationid") %>' CssClass="conversation-link">
                                    <%# Eval("DisplayName") %>
                                </asp:LinkButton>
                            </div>
                        </ItemTemplate>
                ...
                <div class="chat-main">
                    <div class="chat-header">
                        <asp:Label ID="lblChatTitle" runat="server" Text="Select a conversation"></asp:Label>
                    </div>
                    ...
                    <div class="chat-input">
                        <asp:TextBox ID="txtMessage" runat="server" CssClass="message-box" TextMode="MultiLine" Rows="2" placeholder="Type a message..."></asp:TextBox>
